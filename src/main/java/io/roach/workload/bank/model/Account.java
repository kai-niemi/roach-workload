...
import io.roach.workload.bank.service.NegativeBalanceException;
import io.roach.workload.common.util.Money;
import io.roach.workload.common.util.WeightedItem;
...
@Entity
@Table(name = "account")
public class Account extends AbstractEntity<Account.Id> implements WeightedItem {
    @EmbeddedId
